...
class TestInsertBasePath(unittest.TestCase):
    ...
    def test_make_dir(self):
        ...
        '''
        test_dir = get_file_path('test folder', self.base_path)
    ...
    def test_make_relative_dir(self):
        ...
        '''
        test_dir = get_file_path('..', self.base_path)
    ...
    def test_already_full_dir_str(self):
        ...
        '''
        test_dir = get_file_path(str(self.files['test_dir']), self.base_path)
        self.assertEqual(test_dir, self.files['test_dir'])
    ...
    def test_make_file(self):
        ...
        '''
        test_dir = get_file_path('test folder//test_file.txt', self.base_path)
    ...
    def test_make_relative_file(self):
        ...
        test_dir = get_file_path(relative_path, self.base_path)
        self.assertEqual(test_dir, self.files['text_file'])
    ...
    def test_make_file_bad_input(self):
        ...
        with self.assertRaises(TypeError):
            get_file_path(1, self.base_path)
